...
class SetupController:
    def __init__(self, vm_ip: str, vm_port: str,  cache_dir: str):
        self.vm_ip: str = vm_ip
        self.http_server: str = f"http://{vm_ip}:{vm_port}"
        self.http_server_setup_root: str = f"http://{vm_ip}:{vm_port}/setup"
