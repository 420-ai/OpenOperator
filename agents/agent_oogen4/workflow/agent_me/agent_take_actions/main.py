...
logger = logging.getLogger("agent.me-agent.take_actions")
...
def init_agent_take_action(config: OOConfig, state: State) -> RoundRobinGroupChat:
    logger.debug("Initializing agent_take_actions team...")
    ...
    max_messages_termination = MaxMessageTermination(max_messages=config.workflow_settings["max_plan_step_actions"])
