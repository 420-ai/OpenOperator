...
def ensure_cert_generated():
    """
    Runs mitmproxy briefly to force generation of the CA cert.
    """
    ...
    try:
        # Start and immediately shutdown to trigger cert creation
        m.addons.clear()
        m.shutdown()
        time.sleep(1)  # Give time for the file to be written
    except Exception as e:
        print("Error while triggering cert generation:", e)
    finally:
        print("Done.")
